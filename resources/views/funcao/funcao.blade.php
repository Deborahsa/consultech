        ...
        <table class="table table-striped table-condensed">
            ...
            <?php foreach ($funcoes as $f): ?>
                <tr>
                    ...
                    <td>{{$f->descricao}}</td>
                    <td>
                        <a href="javascrip:void(0)" class="btn btn-warning btn-xs editar_funcao" id_funcao="{{$f->id_funcao}}" descricao="{{$f->descricao}}">
                        <i class="fa fa-pencil" aria-hidden="true"></i>
                        </a>

                        <a href="{{route('excluir_funcao')}}?id_funcao={{$f->id_funcao}}" class="btn btn-danger btn-xs delete">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Cadastrar Funções</h4>
            </div>
            <form action="{{Route('cadastro_funcao')}}" id="funcao_cadastro" method="post">
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="col-sm-6 pad-left">
                            <label for="descricao">Função: </label>
